...
translation very well, it is just one of the many text analytics tasks that modern AI
...
we feed them to the patterns they have encountered during the training phase.
...
that a session of questions and answers with GPT-3 (roughly 10 t0 50 responses) 
...
Use of a **commercial nature** is less lilely to be considered fair than use for 
