...
factors are present, we try to establish causation by a process called [**causal inference**](https://en.wikipedia.org/wiki/Causal_inference). By studying which variables act on each other, causality can be inferred.
