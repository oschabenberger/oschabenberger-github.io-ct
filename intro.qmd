...
A **surrogate** metric is one that is used in the place of another. We have seen 
earlier how economic indicators are used to describe aspects of the economy:
...
- Cardiovascular health: directly measuring cardiovascular health is difficult. 
Cholesterol levels are used as a proxy for heart health.
...
- Employment: Measuring employee productivity by number of hours worked or 
by number of days in the office (vs. WFH).

- Technology: 
    - Number of downloads of an app as a measure of market share.
    - Likes and shares as a measure of social media engagement

- Academia: Citation count as a surrogate for research impact. 
...
Another aspect of surrogation is to prioritize the simple fixes and quick wins
...
::::
::::{.assignment-container}
Find a few additional real life examples of surrogation, where chasing the metric has become 
more important than achieving the underlying goal the metric represents.
::::
:::

#### Predictions as surrogates

The predictions of a statistical model are often used as surrogates for values 
that are difficult or impossible to observe or when the method of observing the
value destroys the object itself.
...
::::
::::{.example-container}
One method for quantifying the aerobic fitness of athletes is through testing
...
Then, you develop a model that can predict aerobic capacity from the easy-to-measure
...
of construction, humidity, temperature, etc.
...
be used as surrogate for the actual board nail pull strength.
::::
:::
